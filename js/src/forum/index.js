  ...
  extend(SignUpModal.prototype, 'fields', function (items) {
    ...
    if (app.forum.attribute('justoverclock-country-flags.setCountryFlagsOnRegistration')) {
      ...
      items.add(
        "countryCode",
        <div className="Form-group">
          <select style="width: 100%; margin: 0 auto; text-align: center; height: 50px;" className="FormControl countryCode" id="countryCode" name="countryCode" placeholder="Country Code" aria-invalid="false">
            <option value="" disabled selected>
              {app.translator.trans(
                "justoverclock-country-flags.forum.clickToSelectCountry"
              )}
            </option>
